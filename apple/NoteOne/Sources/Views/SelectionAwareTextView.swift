...
private struct SelectionAwareTextViewImpl: NSViewRepresentable {
    ...
    func updateNSView(_ scroll: NSScrollView, context: Context) {
        ...
        if tv.string != text {
            // External update (e.g. Notty applied an action) — preserve a reasonable
            // selection by clamping the existing one to the new length.
            ...
            // Selection driven from Swift state (e.g. after applying an insert).
