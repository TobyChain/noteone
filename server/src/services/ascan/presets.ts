...
export interface AscanPreset {
  id: string;
  name: string;
  description: string;
  config: Partial<AscanConfig>;
}

export const PRESETS: AscanPreset[] = [
  {
    id: "default",
    name: "默认推荐",
...
export function applyPreset(preset: AscanPreset): Partial<AscanConfig> {
